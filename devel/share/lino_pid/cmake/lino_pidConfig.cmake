...
if(NOT "/home/ubuntu/linorobot_ws/devel/include;/home/ubuntu/linorobot_ws/src/lino_pid-master/include " STREQUAL " ")
  set(lino_pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/linorobot_ws/devel/include;/home/ubuntu/linorobot_ws/src/lino_pid-master/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lino_pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/linorobot_ws/src/lino_pid-master/${idir}'.  ${_report}")
    endif()
