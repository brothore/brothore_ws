...
(cl:defmethod cl:initialize-instance :after ((m <running_time>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'running_time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lino_msgs-msg:<running_time> is deprecated: use lino_msgs-msg:running_time instead.")))

(cl:ensure-generic-function 'time0_pub-val :lambda-list '(m))
(cl:defmethod time0_pub-val ((m <running_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lino_msgs-msg:time0_pub-val is deprecated.  Use lino_msgs-msg:time0_pub instead.")
  (time0_pub m))

(cl:ensure-generic-function 'time0_sub-val :lambda-list '(m))
(cl:defmethod time0_sub-val ((m <running_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lino_msgs-msg:time0_sub-val is deprecated.  Use lino_msgs-msg:time0_sub instead.")
  (time0_sub m))

(cl:ensure-generic-function 'time1_pub-val :lambda-list '(m))
(cl:defmethod time1_pub-val ((m <running_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lino_msgs-msg:time1_pub-val is deprecated.  Use lino_msgs-msg:time1_pub instead.")
  (time1_pub m))

(cl:ensure-generic-function 'time1_sub-val :lambda-list '(m))
(cl:defmethod time1_sub-val ((m <running_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lino_msgs-msg:time1_sub-val is deprecated.  Use lino_msgs-msg:time1_sub instead.")
  (time1_sub m))

(cl:ensure-generic-function 'time2_pub-val :lambda-list '(m))
(cl:defmethod time2_pub-val ((m <running_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lino_msgs-msg:time2_pub-val is deprecated.  Use lino_msgs-msg:time2_pub instead.")
  (time2_pub m))

(cl:ensure-generic-function 'time2_sub-val :lambda-list '(m))
(cl:defmethod time2_sub-val ((m <running_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lino_msgs-msg:time2_sub-val is deprecated.  Use lino_msgs-msg:time2_sub instead.")
  (time2_sub m))
